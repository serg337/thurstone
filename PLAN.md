...
Current continuation: Gates 0–8 passed, including the provider-free Thurstone presentation
transition on `ca18dd438c5499107bbf9937460cc2faaab14ade`. Canonical Brief v2, sealed evidence build
`768af2539ca20c29928a897644ad22ba897c580d`, the 24-case Meaning Matrix, and the authentic
`23/24 → 23/24` no-improvement result remain frozen. Gate 8.5 now adds exactly three deterministic,
zero-model-call Invocation Integrity cases as a separately scored supplement. Gate 9 preparation
resumes only after Gate 8.5 passes; publication, release tagging, video upload, legal confirmation,
Devpost submission, and final freeze remain one consolidated human handoff.
...
| 8.5  | Three frozen direct WebMCP invocation-integrity cases, trusted server ledger, separate Matrix and evidence                                | Gate 8     | Amendment freeze, 3/3 supplemental evidence, exact-SHA native Chrome proof, independent closeout         | In progress |
| 9    | Human approval, collateral-only release commit, public repository/tag/release, video, Devpost receipt, freeze                             | Gate 8.5   | One truthful immutable submission chain and freeze receipt                                               | Pending     |
