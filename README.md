...
| Judge-accessible model-backed lane                             | Activation-ready four-case custom Probe; disabled by default until the exact reviewed production commit    |
