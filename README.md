...
| `TOOLPROOF_JUDGE_PRESENTATION_BINDING_B64`, `TOOLPROOF_JUDGE_PRESENTATION_BINDING_HASH`                                  | Digest-bound recovery/release lineage; permits at most one exact link-only release hop                                        |
