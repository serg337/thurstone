...
export const PROBE_RUNNER_PROMPT_VERSION = "toolproof-probe-runner-prompt@1.0.0";
...
export const PROBE_GENERIC_RUNNER_PROMPT = [
  ...
  'Choose kind "clarify" when material information needed to choose or populate a tool is missing.',
