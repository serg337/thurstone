...
| Sandbox           | Deterministic checkout/review domain and five safe tools                                                                       | `6a42336` (fixture + `cart_get`; Gate 1 pending)                      |
| Evaluation        | Immutable lifetime policy, signed-token/atomic Redis guard, disabled Probe routes; model runner/evidence lineage still pending | Gate 0 control checkpoint pending                                     |
