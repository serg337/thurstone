...
| Sandbox           | Deterministic checkout/review store, five safe tools, replay tombstones, dynamic registry, native adapter, reset, traces, and one-button timed verified proof export | Gate 1 one-button candidate under verification; exact deployed/native-proof commit pending |
