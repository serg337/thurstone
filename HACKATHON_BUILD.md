...
| Sandbox           | Deterministic checkout/review store, five safe tools, replay tombstones, dynamic registry, native adapter, reset, traces, and one-file hash-bound proof export | Gate 1 export-enabled candidate under verification; exact deployed/native-proof commit pending |
